...
(lazy-one-key-create-menu
 ...
 (:key "f" :description "Home" :command (lambda () (interactive) (find-file "D:\\workWs_yl_Agile\\03_projectTanks\\02_项目方案和计划\\Documents")))
 (:key "c" :description "Emacs Config" :command (lambda () (interactive) (find-file "D:\\EmacsConfig\\.emacs.d")))
 (:key "g" :description "Github" :command (lambda () (interactive) (find-file "D:\\workWs_yl_Agile\\03_projectTanks\\02_项目方案和计划\\github")))
 (:key "p" :description "Project" :command (lambda () (interactive) (find-file "D:\\workWs_yl_Agile\\03_projectTanks\\02_项目方案和计划\\项目执行\\0_移动平台调研\\足式机器人")))
