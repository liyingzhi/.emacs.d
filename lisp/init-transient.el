...
(pretty-transient-define-prefix transient-toggles ()
  ...
  [["Basic"
   ...
   ["Program"
    ...
    ("m" "Move Style" +lizqwer/toggle-move-style
     :toggle (bound-and-true-p user/move-style-motion) :transient t)]
   ...
   ["LLM"
    ("l f" "llm free" my/switch-gptel-llm  :toggle (equal gptel-model user/ai-model-free) :transient t)
    ("l c" "llm coder" my/switch-gptel-llm-coder :toggle (equal gptel-model user/ai-model-coder) :transient t)]]
